...
noremap ,p<up> :call HPasteWindow('up')<cr>
noremap ,p<down> :call HPasteWindow('down')<cr>
noremap ,p<left> :call HPasteWindow('left')<cr>
noremap ,p<right> :call HPasteWindow('right')<cr>
