local function get_default_mappings()
	...
	local mappings = {
		...
		n = {
			...
			["<leader>gs"] = { "<cmd>term lazygit status<cr>", " Git status…" },
			["<leader>gl"] = { "<cmd>term lazygit log<cr>", " Git log…" },
			["<leader>gn"] = features.neogit and { name = "Neogit…" },
			["<leader>gns"] = features.neogit and { "<cmd>Neogit<cr>", " Git status…" } or nil,
			["<leader>gnc"] = features.neogit and { "<cmd>Neogit commit<cr>", " Git commit…" } or nil,
			...
			["<leader>xa"] = { "<cmd>silent %bd!<cr>", " Close all" },
			["<leader>xo"] = {
		...
		nv = {
			...
			["gP"] = features.hop and { "<cmd>noh | HopPatternMW<cr>", "Find pattern (all windows)…" } or nil,
