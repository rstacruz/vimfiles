...
return {
  ...
  { -- indent-o-matic: Detect indents
    ...
    enable = features.indent_detection,
  },
  ...
  { -- fugitive: Git blame and open in GitHub
    "tpope/vim-fugitive",
    enable = features.github_fugitive,
    event = "VeryLazy",
  ...
  { -- treesitter playground
    ...
    enable = features.treesitter_playground,
    event = "VeryLazy",
    requires = {
      { "nvim-treesitter/nvim-treesitter" },
    },
