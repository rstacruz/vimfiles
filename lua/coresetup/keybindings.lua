local function get_default_mappings()
	...
	local mappings = {
		...
		n = {
			...
			["ga"] = { "<cmd>HopChar1<cr>", "Go to character…" },
			["gA"] = { "<cmd>HopChar1MW<cr>", "Go to character (all windows)…" },
			["gs"] = { ":%s~~", "Replace with…" },
			["gp"] = features.hop and { "<cmd>HopPattern<cr>", "Go to pattern…" } or nil,
			["gP"] = features.hop and { "<cmd>HopPatternMW<cr>", "Go to pattern (all windows)…" } or nil,
