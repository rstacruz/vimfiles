...
" End of buffer
hi! _invis     ctermfg=255   ctermbg=none

" Base colors!!
hi! _base_a ctermfg=none ctermbg=none " Base
...
hi! link _normal_300 _base_a  " Semi-noise
hi! link _normal_400 _base_a  " Standard colors
hi! link _normal_900 _base_a  " Bold
hi! link _normal _normal_400

" [base] comments:
hi! link _comment_400 _base_m

" Base color (return, const, function):
hi! link _base_400   _base_b   " return, const, function
hi! link _base_900   _base_b   " if, while, for, func calls (map, filter)

" Accent/value colors (strings):
hi! link _accent_400   _base_m         " strings
hi! link _accent_200   _base_m         " true, false, nil
