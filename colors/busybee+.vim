...
if version >= 700
  ...
  hi CursorColumn  guibg=#000000 ctermbg=234
  hi MatchParen    guifg=#d0ffc0 guibg=#000000 gui=bold ctermfg=157 ctermbg=237 cterm=bold
  hi Pmenu 		   guifg=#ffffff guibg=#000000 ctermfg=255 ctermbg=238
...
hi LineNr 		   guifg=#303030 guibg=#000000 gui=none ctermfg=244 ctermbg=232
hi StatusLine 	   guifg=#d3d3d5 guibg=#151515 gui=none ctermfg=253 ctermbg=238
hi StatusLineNC    guifg=#424242 guibg=#101010 gui=none ctermfg=246 ctermbg=238
hi VertSplit 	   guifg=#202020 guibg=#202020 gui=none ctermfg=238 ctermbg=238
...
hi Todo            guifg=#ff9f00 guibg=#000000 gui=none
